  ...
  return (
    <div className="flex justify-end w-full">
      <div className="relative w-full">
        ...
        />
        <kbd className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-[10px] text-(--text-muted) font-mono border border-(--border) rounded px-1.5 py-0.5">
          Space
        </kbd>
      </div>
    </div>
